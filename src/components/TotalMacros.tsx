  ...
  return (
    <div className="glass-card-strong p-6 rounded-2xl shadow-large animate-fade-in-up sticky top-4">
      ...
      <div className="text-center mb-5">
        <div className="text-5xl font-extrabold mb-1 text-white">{totalCalories}</div>
        <div className="text-sm text-white/70">Calories</div>
      </div>
      
      <div className="grid grid-cols-3 gap-4 pt-4 border-t border-white/20">
        <div className="text-center">
          <p className="text-2xl font-bold mb-1 text-white">{totalProtein}g</p>
          <p className="text-xs text-white/70">Protein</p>
        </div>
        <div className="text-center">
          <p className="text-2xl font-bold mb-1 text-white">{totalCarbs}g</p>
          <p className="text-xs text-white/70">Carbs</p>
        </div>
        <div className="text-center">
          <p className="text-2xl font-bold mb-1 text-white">{totalFat}g</p>
